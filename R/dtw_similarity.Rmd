...
ggsave("figures/dtw/rcp_distance.png", width=4, height=4, dpi=300)
```
...
```{r, include=FALSE, echo=FALSE}
ggsave("figures/dtw/bp_distance.png", width=4, height=3.5, dpi=300)
```
...
```{r, include=FALSE, echo=FALSE}
ggsave("figures/dtw/bp_distance_by_cond_round.png", width=6.5, height=3.5, dpi=300)
```
...
### Model 1: [pair] condition * round_c
```{r}
...
### Model 2: [pair] condition_sum * round_c
```{r}
...
```{r, include=FALSE, echo=FALSE}
ggsave("figures/dtw/posterior_mln_dtw.png", width=4.5, height=4, dpi=300)
```
...
```{r, include=FALSE, echo=FALSE}
ggsave("figures/dtw/bayes_factor_dtw.png", width=6, height=4, dpi=300)
```
